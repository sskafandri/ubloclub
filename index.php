												...
												<div class="card-body">
													<?php if(isset($cart_items[0])){ ?>
														<form action="actions.php?a=update_cart_checkout" enctype="multipart/form-data" method="post" class="cart">
															...
															<div class="form-row">
																<div class="form-group col">
																	<?php if( !isset( $_SESSION['shipping_id'] ) || empty( $_SESSION['shipping_id'] ) ) { ?>
				...
				<div role="main" class="main shop py-4">
					<div class="container">
						...
						<form action="https://agechecked.com/api/acapiremote/cceroll" id="frmBillingAddress" method="post">
							...
							<input type="hidden" id="merchantSecretKey" name="merchantSecretKey" class="form-control" value="UbloClub">
						...
						<div class="col-md-9 text-center text-md-left">
							...
							<div class="row footer-top-light-border mt-4 pt-4">
								<div class="col-lg-5 text-center text-md-left">
									<p class="text-2 mt-1">
										© Copyright <?php echo date("Y", time()); ?>. All Rights Reserved. <br>
										UK Registered Company No: 12182038. <br>
										VAT No: GB 333 2139 35. <br>
										Data Protection Registration No: ZA620842
									</p>
								</div>
								<!--
